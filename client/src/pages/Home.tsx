...
const cards = [
  { label: "Satellite internet", title: "Starlink", text: "Clear-sky positioning, secure mounting and a clean, tested handover.", image: "/service-starlink.jpg", icon: Satellite },
  { label: "Property security", title: "CCTV", text: "Camera systems that let you see your site clearly, wherever you are.", image: "/service-cctv.jpg", icon: ShieldCheck },
  { label: "Connected spaces", title: "Wi-Fi", text: "Coverage and cabling planned for the way your building is actually used.", image: "/service-network.jpg", icon: Wifi },
];
    ...
    <SiteLayout variant="showcase">
      ...
      <section ref={heroRef} className="atlas-hero atlas-reference-hero">
        <div className="atlas-reference-panel">
          ...
          <motion.img className="atlas-reference-tech-still" src="/hero-tech-still-life.png" alt="" aria-hidden="true" style={reduceMotion ? undefined : { x: techX }} />
          ...
          <motion.div className="atlas-reference-visual" initial={{ opacity: 0, scale: .94 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: .85, delay: .16, ease: [0.22, 1, 0.36, 1] }} style={reduceMotion ? undefined : { y: visualY, rotate: visualRotate }}>
            ...
            <img src="/woman with no background.png" alt="SparkLink technology consultant holding a tablet" fetchPriority="high" />
